...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [_BASE] = LAYOUT(
        ...
        KC_TAB,  KC_Q,    KC_W,    KC_F,    KC_P,    KC_G,    KC_J,    KC_L,    KC_U,    KC_Y,    KC_:,    KC_LBRC, KC_RBRC, KC_BSLS,          KC_PGUP,
        KC_CAPS,  KC_A,   KC_R,    KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_I,    KC_SCLN, KC_QUOT,          KC_ENT,           KC_PGDN,
